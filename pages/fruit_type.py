...
register_page(__name__, path='/fruit_type',
              title='Fruit Type', name='Fruit Type')
...
layout = html.Div([
    html.Div([
        ...
        html.Div(id='output-filename-fruit'),
    ]),
    html.Div([
        html.Button('Submit', id='submit-file-btn-fruit', n_clicks=0),
    ], className="process-btn-div"),
    html.Div(id='model_output-fruit', className="model-output-div"),
], className="twelve columns page_div")


# ------------- Callback Methods ----------------
@callback(Output('output-filename-fruit', 'children'),
          Input('upload-data-fruit', 'contents'),
          State('upload-data-fruit', 'filename'),
          State('upload-data-fruit', 'last_modified'),
...
model = load_model(r'Harvest2.h5')  # Load the saved model
...
@callback([Output('model_output-fruit', 'children'),
           ],
          Input('submit-file-btn-fruit', 'n_clicks'),
          State('upload-data-fruit', 'contents'),
          State('upload-data-fruit', 'filename'),
          State('upload-data-fruit', 'last_modified'),
          prevent_initial_call=True
          )
